...
class RealAjaxUploader
{
	...
	private function message($status, $msg, $extra_info='', $content1='', $content2='')
	{
		$this->header();
		echo json_encode(array('name'=>$this->file_name, 'size'=>$this->file_size, 'status'=>$status,'info'=>$msg, 'more'=>$extra_info, 'content1'=>$content1, 'content2'=>$content2));
		die();
	}
